...
namespace Microservicio.Usuario.Services
{
    public interface IUsuarioService
    {
        ...
        public Task<bool> CambiarEstadoAsync(string identificacion, int nuevoEstadoId);
        public Task<bool> ActualizarFotografiaAsync(string identificacion, string fotoBase64);
        ...
        Task<bool> EliminarUsuarioAsync(string identificacion);
    }
}
